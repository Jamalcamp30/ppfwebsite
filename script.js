  ...
  cards.forEach(function(card){
    card.addEventListener('click', function(){
      ...
      if(result && messages[path]){
        result.innerHTML = '<div class="path-message">' + messages[path] + ' <a href="#contact" class="btn primary" style="margin-top:16px;display:inline-flex">Start Your Plan</a></div>';
      }
    });
  });
})();
  ...
  function initStackBuilder(){
    ...
    function renderStack(){
      ...
      resultEl.innerHTML = '<div class="rc-stack-recommendation">' +
        ...
        '<div class="rc-stack-rec-cta"><a href="#contact" class="btn primary">Start Your Plan</a></div>' +
        '</div>';
    }
  }
...
(function(){
  ...
  var sectionYards = [
    ...
    { id:'ppf-process',      yard:25 },
    { id:'outcome-wall',     yard:32 },
    { id:'system',           yard:40 },
    { id:'draft-board',      yard:48 },
    { id:'ras-board',        yard:54 },
    { id:'ras-simulator',    yard:58 },
    { id:'draft-room',       yard:62 },
    { id:'measurables',      yard:68 },
    { id:'media',            yard:74 },
    { id:'coach',            yard:80 },
    { id:'recovery',         yard:90 },
    { id:'contact',          yard:100}
